function [B,ctrl_state,polarPosition]  = Controller(startButton,bodyState,DesiredImpedenceValues,DesiredRaibertValues,theta_ML,theta_MR,dtheta_ML,dtheta_MR)
    ...
    elseif startButton == 2
       ...
       % (1 = Flight, 2 = Loading, 3 = Compression, 4 = Thrust, 5 = Unloading)
        ...
        if state == State.Flight
            ...
            x_foot = 0.5*dx_body*0.23 + GAIN_dx*(dx_body - dx_des);
