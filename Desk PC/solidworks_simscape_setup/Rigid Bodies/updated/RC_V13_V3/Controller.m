function [B,ctrl_state,polarPosition,tau]  = Controller(startButton,bodyState,DesiredImpedenceValues,DesiredRaibertValues,theta_ML,theta_MR,dtheta_ML,dtheta_MR)
